                           ...
                           MPI_Datatype datatype, MPI_Status * status)
{
    ...
    if (buftype_is_contig && filetype_is_contig) {
        ...
        // CHANGE
        // ADIO_ReadContig(adio_fh, xbuf, count, datatype, ADIO_EXPLICIT_OFFSET, off, status, &error_code);
        Async_ReadContig(adio_fh, xbuf, count, datatype, ADIO_EXPLICIT_OFFSET, off, status, &error_code);
        // END CHANGE
