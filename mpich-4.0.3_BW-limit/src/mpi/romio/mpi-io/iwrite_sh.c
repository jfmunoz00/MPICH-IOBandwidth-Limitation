                             ...
                             MPI_Datatype datatype, MPIO_Request * request)
{
    ...
    if (buftype_is_contig && filetype_is_contig) {
        ...
        // CHANGE
        // ADIO_IwriteContig(adio_fh, buf, count, datatype, ADIO_EXPLICIT_OFFSET, off, request, &error_code);
        Async_IwriteContig(adio_fh, buf, count, datatype, ADIO_EXPLICIT_OFFSET, off, request, &error_code);
        // END CHANGE
            ...
            // CHANGE
            // ADIO_WriteContig(adio_fh, buf, count, datatype, ADIO_EXPLICIT_OFFSET, off, &status, &error_code);
            Async_WriteContig(adio_fh, buf, count, datatype, ADIO_EXPLICIT_OFFSET, off, &status, &error_code);
            // END CHANGE
