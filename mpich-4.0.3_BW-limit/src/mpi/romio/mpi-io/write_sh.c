                            ...
                            MPI_Datatype datatype, MPI_Status * status)
{
    ...
    if (buftype_is_contig && filetype_is_contig) {
        ...
        ADIO_WriteContig(adio_fh, xbuf, count, datatype, ADIO_EXPLICIT_OFFSET, off, status, &error_code);
        // CHANGE
        // ADIO_WriteContig(adio_fh, xbuf, count, datatype, ADIO_EXPLICIT_OFFSET, off, status, &error_code);
        Async_WriteContig(adio_fh, xbuf, count, datatype, ADIO_EXPLICIT_OFFSET, off, status, &error_code);
        // END CHANGE
